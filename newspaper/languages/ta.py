"""This module provides a tokenizer function for Tamil
...
try:
    ...
    raise ImportError(
        "You must install indic-nlp-library before using the Tamil tokenizer. \n"
        "Try pip install indic-nlp-library\n"
        "or pip install newspaper4k[ta]\n"
...
def tokenizer(text):
    """
    Tokenizes the given Tamil text by removing punctuation and extra spaces and
    ...
    return trivial_tokenize(text, "ta")
